...
尽管如此，本研究仍提供了三类可核验结果。其一，思路外化、代码重构、角色反转教学和错误代码修正能够被组织成一条可运行的程序设计学习流程。其二，在117个学生账户中有42名学生采用，采用者大多重复且跨作业使用；稳定版本398次会话中有224次完成，主要流失点位于第一阶段有效活动之前和第二阶段。其三，现有代码提交指标没有显示稳定的条件关联，也不足以回答学习效果问题。
